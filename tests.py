...
class HaveDigitRuleTest(unittest.TestCase):
    ...
    def test_fix_validation_issue_if_needed(self):
        ...
        self.assertTrue(
            self.rule._contains_digit(
                self.rule.fix_validation_issue_if_needed("abcdef")
            )
        )
...
class CorrectLengthTest(unittest.TestCase):
    ...
    def test_diff_max_min(self):
        self.assertTrue(
            2 <= len(self.rule28.fix_validation_issue_if_needed("1234")) <= 8
        )
        self.assertTrue(
            2 <= len(self.rule28.fix_validation_issue_if_needed("123456789012")) <= 8
        )
...
class SeriesRuleTest(unittest.TestCase):
    ...
    def test_fix_validation_issue_if_needed(self):
        self.assertEqual(
            "aaabbccca", self.rule3.fix_validation_issue_if_needed("aaaabbcccccca")
        )
        self.assertEqual(
            "aaabb???ccca",
            self.rule3.fix_validation_issue_if_needed("aaaabb??????cccccca"),
        )
        self.assertEqual(
            "aaaąąąbbccca",
            self.rule3.fix_validation_issue_if_needed("aaaaąąąąąąąbbcccccca"),
        )
...
class SpecialCharRuleTest(unittest.TestCase):
    ...
    def test_fix_validation_issue_if_needed(self):
        ...
        self.assertTrue(
            self.rule._contain_special_characters(
                self.rule.fix_validation_issue_if_needed("abcdef")
            )
        )
...
class UtilsTest(unittest.TestCase):
    ...
    def test_generate_random_password_errors_handling(self):
        with self.assertRaises(ValueError):
            genrate_random_password(-1)
